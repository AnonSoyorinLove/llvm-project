...
// RUN: %clang -### -target aarch64-linux-gnu -fstruct-layout-reloc -fstruct-layout-reloc-global-extra-bytes=32 -c %s 2>&1 \
...
// RESERVE: -fstruct-layout-reloc-global-extra-bytes=32
